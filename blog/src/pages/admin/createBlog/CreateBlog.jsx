...
//     const addPost = async () => {
//         if (currentBlog.title === "" || currentBlog.category === "" || currentBlog.content === "" || !thumbnail) {
//             toast.error('Please Fill All Fields');
//             return;
//         }
//         uploadImage();
...
//                 try {
//                     addDoc(productRef, {
//                         blogs: [...blogs, { ...currentBlog, thumbnail: url }],
//                         thumbnail: url,
//                         time: Timestamp.now(),
//                         date: new Date().toLocaleString(
//                             "en-US",
...
//                     navigate('/dashboard');
//                     toast.success('Post Added Successfully');
//                     setBlogs([...blogs, { ...currentBlog, thumbnail: url }]);
//                     setCurrentBlog({
//                         title: '',
//                         category: '',
//                         content: '',
...
//                     apiKey='p2yfiq2y712aw8ssnkryydvoq12dms7x1r5sg11bdv9466p6'
//                     onEditorChange={(newValue, editor) => {
//                         setCurrentBlog({ ...currentBlog, content: newValue });
//                         setText(editor.getContent({ format: 'text' }));
//                     }}
//                     onInit={(evt, editor) => {
//                         setText(editor.getContent({ format: 'text' }));
...
//                         [&>img]:rounded-lg
//                         `}
//                             dangerouslySetInnerHTML={createMarkup(currentBlog.content)}>
//                         </div>
//                     </div>
//                 </div>
//             </div>
